...
<script type="text/javascript" src="/resources/lib/js/sweetalert.min.js?ver=1"></script>
<link rel="stylesheet" type="text/css"
	href="/resources/lib/css/sweetalert.css?ver=1.2">
<script type="text/javascript" src="/resources/lib/js/stringBuffer.js"></script>
<script type="text/javascript" src="/resources/lib/js/calendar.js"></script>
<script type="text/javascript" src="/resources/lib/js/calendarSchdule.js"></script>
<style type="text/css">
thead {
	text-align: center;
}
			...
			<tr>
				<td colspan="7">
					...
					<button type="button" class="btn btn-sm btn-warning" id="movePre"
						onclick="moveMonthPre()">&lsaquo;</button>	&nbsp;&nbsp;
